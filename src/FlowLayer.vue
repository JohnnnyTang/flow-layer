...
import { GetMap } from './customLayer/cusLayer';
...
import { FlowFieldManager } from './customLayer/flowfield';
import { FlowLayer } from './customLayer/flowLayer';
...
onMounted(async () => {
  ...
  let flowFieldManager = new FlowFieldManager('http://localhost:8080/json/flow_field_description.json');
